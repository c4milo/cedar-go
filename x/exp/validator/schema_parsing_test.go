			...
			"entityTypes": {
				"User": {
					"shape": {
						"type": "Record",
						"attributes": {
							"email": {"type": "EntityOrCommon", "name": "EmailAddress", "required": true},
							"location": {"type": "EntityOrCommon", "name": "Coordinate", "required": true}
						}
					}
				}
			},
				...
				"User": {
					"shape": {
						...
						"attributes": {
							...
							"anyEntity": {"type": "Entity", "name": "User", "required": true}
						}
					}
				}
			},
				...
				"User": {
					"shape": {
						...
						"attributes": {
							...
							"anySet": {"type": "Set", "element": {"type": "String"}, "required": true}
						}
					}
				}
			},
